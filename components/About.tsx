...
const About = ({ className = "" }) => {
  return (
    <div
      className={`${className} container col-span-1 hidden h-[629px] flex-col overflow-y-auto rounded-lg bg-black/10 px-6 text-black shadow-sm shadow-black md:block`}
    >
      ...
      <p className="mx-auto px-4 text-center text-lg text-black/75 lg:hidden">
      ...
      <p className="mx-auto hidden px-4 text-center text-lg text-black/75 lg:block">
      ...
      <div className="text-center">
        <Link
          href="/contact"
          className="mt-4 bg-white/10 inline-flex items-center justify-center rounded-lg px-4 py-2 shadow-sm shadow-black text-black hover:white-white/20"
        >
          Get In Touch
        </Link>
      </div>
