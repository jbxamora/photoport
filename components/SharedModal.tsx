    ...
    >
      ...
      >
        ...
        <div className="w-full my-auto overflow-hidden py-2">
          <div className="relative flex aspect-[1/1.5] items-center justify-center">
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                <Image
                  ...
                  width={navigation ? 750 : 1920}
                  height={navigation ? 853 : 1280}
                  priority
                  alt="Sergio Urbina Photography"
        ...
        <div className="absolute inset-0 mx-auto flex max-w-7xl items-center justify-center">
          ...
          {/* Bottom Nav bar */}
          {navigation && (
            <div className="fixed inset-x-0 bottom-0 z-40 overflow-hidden bg-gradient-to-b from-black/0 to-black/60 pt-4">
              <motion.div
                initial={false}
